...
SECRET_KEY = os.environ.get(
    "DJANGO_SECRET_KEY",
    "django-insecure-dev-key-change-in-production-x9k2m4p6",
)
...
# Render and Railway provide DATABASE_URL; fall back to individual env vars or SQLite for local dev.
...
if _database_url:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": os.environ.get("DB_NAME", "studio_portal"),
            "USER": os.environ.get("DB_USER", "studio"),
            "PASSWORD": os.environ.get("DB_PASSWORD", "studio_dev_pass"),
