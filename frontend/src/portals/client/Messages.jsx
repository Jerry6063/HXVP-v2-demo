        ...
        <div className="lg:col-span-1 space-y-2">
          {isLoading ? (
            ...
            messages.map((msg) => (
              <div
                key={msg.id}
                onClick={() => { setSelectedId(msg.id); setShowNew(false); }}
...
function NewMessageForm({ projects, onSubmit, loading, onCancel }) {
  ...
  const handleSubmit = (e) => {
    ...
    if (form.project) payload.project = parseInt(form.project, 10);
    onSubmit(payload);
  };
